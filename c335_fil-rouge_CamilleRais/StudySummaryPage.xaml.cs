/******************************************************************************
** PROGRAMME  StudySummaryPage.xaml.cs                                       **
**                                                                           **
...
** DESCRIPTION                                                               **
**                                                                           **
** Page de résumé affichée à la fin du mode d'apprentissage.                 **
** Reçoit les stats depuis StudyPage et les affiche :                        **
** temps passé, carte la plus difficile, cartes connues à 100%               **
** et pourcentage de mémorisation.                                           **
**                                                                           **
******************************************************************************/
...
namespace c335_fil_rouge_CamilleRais
{
    public partial class StudySummaryPage : ContentPage, IQueryAttributable
    {
        ...
        /// <param name="eventBack"></param>
        private async void OnBackClicked(object sender, EventArgs eventBack)
        {
